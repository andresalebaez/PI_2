...
st.markdown('''Streamlit es una librería que permite crear `aplicaciones web` para Data Science y Machine Learning de forma rápida y sin necesidad de saber otro lenguaje de programación, debido a que son `desarrolladas puramente en Python`.
...
st.markdown('''Para tener un `dashboard en Python` necesitamos unir la manipulación de datos con la visualización, e incorporar interacción con el usuario.
